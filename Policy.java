public class Policy{  
   ...
   */
   ...
   /**
   * @param pName - the policyholder's name
   */
   ...
   */
   ...
   /**
   * @param BMI - get the provider's bmi
   */
   ...
   public double getPrice(){
      ...
      if(getBMI() > BMI_THRESHOLD) //BMI over 35
         price += ((getBMI() - BMI_THRESHOLD) * ADDITIONAL_FEE_PER_BMI); //additional BMI fee
